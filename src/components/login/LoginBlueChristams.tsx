...
`
const NormalTopCenter=styled.div`  
    position:absolute;  
    width:100%;
    height:700px;   
    left:0px;
    top:0px;
    background-image: url("/images/login/sd_mask_1.png");    
...
const FullLeftBottom=styled.div`  
    position:absolute;  
    width:606px;
    height:240px;   
    left:0px;
    bottom:0px;
    background-image: url("/images/login/sd_mask_2.png");    
    background-repeat: no-repeat;
